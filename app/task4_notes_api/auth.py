"""
Authentication module for the Notes API
Handles JWT token authentication for secure notes management
"""
...
SECRET_KEY = "notes-api-secret-key-change-in-production"  # Change this in production!
ALGORITHM = "HS256"
...
def create_initial_users():
    ...
    if not os.path.exists("users.json"):
        ...
        print("User 1: username=alice, password=secret")
        print("User 2: username=bob, password=secret")
